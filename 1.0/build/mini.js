...
gallery/crossimage/1.0/cdnPoints
gallery/crossimage/1.0/cdnNearest
gallery/crossimage/1.0/webp
gallery/crossimage/1.0/index
gallery/crossimage/1.0/mini

*/
/* 不要手动修改这份文件！用cdnSort_node.js来生成 */
KISSY.add('gallery/crossimage/1.0/cdnPoints',function(){
...
KISSY.add('gallery/crossimage/1.0/cdnNearest',function(S,cdnPoints) {
...
KISSY.add('gallery/crossimage/1.0/webp',function(S) {
...
KISSY.add('gallery/crossimage/1.0/index',function (S,cdnNearest,WebpSupport) {
 ...
 * @module crossimage
 **/
KISSY.add('gallery/crossimage/1.0/mini',function(S, Component) {
