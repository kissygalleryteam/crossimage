...
gallery/crossimage/1.1/cdnPoints
gallery/crossimage/1.1/cdnNearest
gallery/crossimage/1.1/webp
gallery/crossimage/1.1/index
gallery/crossimage/1.1/mini

*/
/* 不要手动修改这份文件！用cdnSort_node.js来生成 */
KISSY.add('gallery/crossimage/1.1/cdnPoints',function(){
...
KISSY.add('gallery/crossimage/1.1/cdnNearest',function(S,cdnPoints) {
...
KISSY.add('gallery/crossimage/1.1/webp',function(S) {
...
KISSY.add('gallery/crossimage/1.1/index',function (S,cdnNearest,WebpSupport) {
 ...
 * @module crossimage
 **/
KISSY.add('gallery/crossimage/1.1/mini',function(S, Component) {
